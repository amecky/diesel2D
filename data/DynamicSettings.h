...
typedef std::vector<DataDefinition> Definitions;
	...
	// add int member
	// -------------------------------------------------------
	void add(const char* name,int* intMember) {
		unsigned idx = numIntMembers;
		m_Members[numIntMembers++] = intMember;
		addDefinition(name,idx,DTR_INT);
	}
	// -------------------------------------------------------
	// add float member
	// -------------------------------------------------------
	void add(const char* name,float* floatMember) {
		//unsigned idx = m_FloatMembers.size();
		//m_FloatMembers.push_back(floatMember);
		unsigned idx = numFloatMembers;
		m_FloatMembers[numFloatMembers++] = floatMember;
		addDefinition(name,idx,DTR_FLOAT);
	}
	// -------------------------------------------------------
	// add Vector2f member
	// -------------------------------------------------------
	void add(const char* name,Vector2f* vec2Member) {
	...
	// add Rect member
	// -------------------------------------------------------
	void add(const char* name,Rect* rectMember) {
	...
	// add Color member
	// -------------------------------------------------------
	void add(const char* name,Color* colorMember) {
